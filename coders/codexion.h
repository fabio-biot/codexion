...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/19 09:16:50 by fchaput           #+#    #+#             */
/*   Updated: 2026/06/19 12:01:11 by fchaput          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			print_state(t_simulation *sim, t_coder *coder,
					char *state, long start_time);
...
void			*process_take_dongle(t_coder *coder,
					t_simulation *sim, t_dongle *dongle);
